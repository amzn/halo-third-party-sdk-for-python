...
from halo_third_party_sdk_events.serialize import DefaultSerializer
from halo_third_party_sdk_events.serialize import SerializationException
...
class TestSerialization(unittest.TestCase):
    ...
    def test_datetime_obj_serialization(self):
        test_obj = datetime.datetime(2021, 1, 1, 10, 20, 30)
        expected_datetime = "2021-01-01T10:20:30"
    ...
    def test_date_obj_serialization(self):
        test_obj = datetime.date(2021, 1, 1)
    ...
    def test_model_obj_serialization(self):
        ...
        test_model_obj_1 = data.ModelTestObject1(
            str_var="test", datetime_var=datetime.datetime(
                2021, 1, 1, 10, 20, 30), obj_var=test_model_obj_2)

        expected_serialized_obj = {
            "var1": "test",
            "var2Time": "2021-01-01T10:20:30",
            "var3Object": {
                "var4Int": 123
            }
        }
...
class TestDeserialization(unittest.TestCase):
    ...
    def test_datetime_obj_serialization(self):
        ...
        test_payload = "2021-01-01T10:20:30"
        test_obj_type = datetime.datetime

        expected_obj = datetime.datetime(2021, 1, 1, 10, 20, 30)
        with patch("json.loads") as mock_json_loader:
            mock_json_loader.return_value = test_payload
    ...
    def test_datetime_obj_serialization_with_timezone(self):
        # payload in iso8601 format
        test_payload = "2021-01-01T10:20:30Z"
        test_obj_type = datetime.datetime

        expected_obj = datetime.datetime(2021, 1, 1, 10, 20, 30, tzinfo=datetime.timezone.utc)
        with patch("json.loads") as mock_json_loader:
            mock_json_loader.return_value = test_payload
            assert self.test_serializer.deserialize(test_payload, test_obj_type) == expected_obj, \
                "Default Serializer deserialized datetime object incorrectly"

    def test_datetime_obj_serialization_with_timezone_and_decimal_fraction(self):
        # payload in iso8601 format
        test_payload = "2021-02-11T00:44:50.993Z"
        test_obj_type = datetime.datetime

        expected_obj = datetime.datetime(2021, 2, 11, 00, 44, 50, 993000, tzinfo=datetime.timezone.utc)
        with patch("json.loads") as mock_json_loader:
            mock_json_loader.return_value = test_payload
            assert self.test_serializer.deserialize(test_payload, test_obj_type) == expected_obj, \
                "Default Serializer deserialized datetime object incorrectly"
    ...
    def test_date_obj_serialization(self):
        # payload in iso8601 format
        test_payload = "2021-01-01"
        test_obj_type = datetime.date

        expected_obj = datetime.date(2021, 1, 1)
        with patch("json.loads") as mock_json_loader:
            mock_json_loader.return_value = test_payload
            assert self.test_serializer.deserialize(test_payload, test_obj_type) == expected_obj, \
    ...
    def test_polymorphic_list_obj_deserialization(self):
        test_payload = ["test", 123, "2021-01-01T10:20:30"]
        test_obj_type = "list[str, long, datetime]"

        deserialized_datetime_obj = datetime.datetime(2021, 1, 1, 10, 20, 30)
    ...
    def test_similar_list_obj_deserialization(self):
        test_payload = ["test", "test1", "2021-01-01T10:20:30"]
        test_obj_type = "list[str]"
        expected_obj = ["test", "test1", "2021-01-01T10:20:30"]
    ...
    def test_dict_obj_deserialization(self):
        test_payload = {
            ...
            "test_date_str": ["2021-01-01T10:20:30"]
        }
    ...
    def test_model_obj_deserialization(self):
        ...
        expected_datetime_obj = datetime.datetime(2021, 1, 1, 10, 20, 30)
