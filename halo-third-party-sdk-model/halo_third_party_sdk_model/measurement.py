...
class Measurement(object):
    ...
    :param value: The user daily, or most recent (if none take for given day), body fat percentage measurements.
    :type value: (optional) float
    :param timestamp: The timestamp for when the data was recorded in extended ISO 8601 date/time format (yyyy-mm-ddThh:mm:ss.mmmZ).
